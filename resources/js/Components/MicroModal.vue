...
<template>
  ...
  <input name="customer" v-model="search" aria-modal="true" aria-labelledby="modal-1-title">
  <button @click="searchCustomers" type="button" class="flex mx-auto text-white bg-teal-500 border-0 py-2 px-8 focus:outline-none hover:bg-teal-600 rounded text-lg">検索</button>
</template>
